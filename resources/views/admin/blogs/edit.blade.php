            ...
            <div>
                ...
                <div class="mt-1.5">
                    <textarea rows="3" name="excerpt" id="excerpt" required placeholder="Provide a short, engaging description to display on the homepage blog card grid (recommended 150-200 characters)..."
                        class="block w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-sm transition-all">{{ old('excerpt', $blog->excerpt) }}</textarea>
                </div>
                @error('excerpt')
                    <p class="mt-1 text-xs text-red-650">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="mt-1.5">
                    <textarea rows="10" name="content" id="content" required placeholder="Write the main body of the article here. HTML tags like <p>, <strong>, <ul>, and <li> are supported for rich formatting."
                        class="block w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-sm transition-all">{{ old('content', $blog->content) }}</textarea>
                </div>
                @error('content')
                    <p class="mt-1 text-xs text-red-650">{{ $message }}</p>
                @enderror
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1.5">
                            <textarea rows="3" name="meta_description" id="meta_description" placeholder="A short description summarizing the article for search results (recommended: 150-160 characters)..."
                                class="block w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-sm transition-all">{{ old('meta_description', $blog->meta_description) }}</textarea>
                        </div>
