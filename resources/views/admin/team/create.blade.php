            ...
            <div>
                ...
                <div class="mt-1.5">
                    <textarea rows="4" name="description" id="description" placeholder="Provide a brief background description of this team member's site capabilities and qualifications..."
                        class="block w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-sm transition-all">{{ old('description') }}</textarea>
                </div>
                @error('description')
                    <p class="mt-1 text-xs text-red-650">{{ $message }}</p>
                @enderror
