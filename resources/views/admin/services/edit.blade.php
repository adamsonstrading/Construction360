                ...
                <div>
                    ...
                    <div class="mt-1.5">
                        <textarea rows="3" name="description" id="description" required
                            class="block w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-sm">{{ old('description', $service->description) }}</textarea>
                    </div>
                    @error('description')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="mt-1.5">
                        <textarea rows="4" name="about" id="about" placeholder="Provide a detailed about description for this service detail page..."
                            class="block w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-sm">{{ old('about', $service->about) }}</textarea>
                    </div>
                    @error('about')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                        ...
                        <div class="bg-slate-50/50 p-4 border border-slate-200 rounded-xl space-y-3 relative sub-service-card">
                            ...
                            <div>
                                ...
                                <textarea rows="2" name="services_offered[{{ $index }}][desc]"
                                    class="block w-full mt-1 px-3 py-2 bg-white border border-slate-200 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-xs sub-service-desc-input">{{ old('services_offered.'.$index.'.desc', $item['desc']) }}</textarea>
                            </div>
                            <div>
                            ...
                            <div class="mt-2 pt-2 border-t border-slate-200/60 space-y-2">
                                ...
                                <div>
                                    ...
                                    <textarea rows="1" name="services_offered[{{ $index }}][meta_description]" placeholder="Short description for search results..."
                                        class="block w-full mt-0.5 px-2 py-1 bg-white border border-slate-200 rounded text-slate-900 focus:outline-none focus:ring-1 focus:ring-[#36a1b3] text-[11px] sub-service-meta-desc-input">{{ old('services_offered.'.$index.'.meta_description', $item['meta_description'] ?? '') }}</textarea>
                                </div>
                                <div>
                        ...
                        <div class="bg-slate-50/50 p-4 border border-slate-200 rounded-xl space-y-3">
                            ...
                            <div>
                                ...
                                <textarea rows="2" name="why_choose_us[{{ $index }}][desc]"
                                    class="block w-full mt-1 px-3 py-2 bg-white border border-slate-200 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-xs">{{ old('why_choose_us.'.$index.'.desc', $item['desc']) }}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                        ...
                        <div class="bg-slate-50/50 p-4 border border-slate-200 rounded-xl space-y-3">
                            ...
                            <div>
                                ...
                                <textarea rows="2" name="faqs[{{ $index }}][a]"
                                    class="block w-full mt-1 px-3 py-2 bg-white border border-slate-200 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-xs">{{ old('faqs.'.$index.'.a', $item['a']) }}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1.5">
                            <textarea rows="3" name="meta_description" id="meta_description" placeholder="A brief summary of the service for search results..."
                                class="block w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#36a1b3] focus:border-transparent text-sm transition-all">{{ old('meta_description', $service->meta_description) }}</textarea>
                        </div>
